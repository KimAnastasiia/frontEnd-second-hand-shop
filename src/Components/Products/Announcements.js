    ...
    return (
        <Card title="All products">
            ...
            {products.map((product) =>
                ...
                <Card style={{ marginTop: 16, marginLeft: 150, marginRight: 150 }} type="inner" title={product.title + " " + product.price + "€"} extra={localStorage.getItem("id") != product.sellerId && <Button type="primary" onClick={() => { showModal(product) }}>Buy</Button>}>
